...
public class RecPow : PowTest
{
    ...
    //Возвращаем строку "RecPow", указывая на то, что это реализация алгоритма рекурсивного возведения в степень.
    ...
    private long RecAlgorithm(int degree)
    {
        ...
        //Если степень нечетная, то результат умножается на себя и умножается на 2, и счетчик увеличивается на 1.
        if (degree % 2 == 1)
        {
            stepsCount++;
            return res * res * 2;
